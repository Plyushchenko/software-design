//TODO Документация; тесты; диаграмма; более детальная версия того, что ниже
Как это работает?
...
Строка (или несколько строк, склееных в одну, если, например, хотим сделать вывод многострочного текста) разбивается по неэкранированным Pipe-ам, затем команды исполняются по очереди.
